...
setwd(Users/jennyli/Downloads/HomeWorks)
...
sex_column <- JennyTitanic$Sex
age_column <- JennyTitanic$Age
...
ggplot(JennyTitanic, aes(x = factor(Survived), y = Freq)) +
